...
local function wBQ8ncN2OyoKWmCo(Tlyrrz46tw)
    if ottersbd.debug then
        Citizen.Trace("[ottersbd] " .. tostring(Tlyrrz46tw) .. ".")
    end
end
...
menus_list = {}
function ottersbd.CreateMenu(jwBQUGRXlPi, tv)
...
function ottersbd.CreateSubMenu(o5_Y4K3Wo8umqV9Jq, K_UkYz2xIa, S30rdV)
    if jwZvXv7xDjl3iWV[K_UkYz2xIa] then
        ottersbd.CreateMenu(o5_Y4K3Wo8umqV9Jq, jwZvXv7xDjl3iWV[K_UkYz2xIa].title)
        if S30rdV then
...
function ottersbd.CurrentMenu()
    return j0P1aYqgapaJmkYWlSEjf
end
function ottersbd.OpenMenu(Wy2HuhjnUT)
...
function ottersbd.IsMenuOpened(lz9JKSXu5)
    return nwxCxw1(lz9JKSXu5)
end
function ottersbd.IsAnyMenuOpened()
...
function ottersbd.IsMenuAboutToBeClosed()
    if jwZvXv7xDjl3iWV[j0P1aYqgapaJmkYWlSEjf] then
...
function ottersbd.Button(ku9eSQBeIjpD5OSIkEo, k59Afs, oMOmUf0EItEu1d)
...
function ottersbd.CheckboxButton(ljn2uEed0X, TRO)
...
function ottersbd.Button2(W, oE9cO8vpv, c)
    local lRCYjuz7bRV = W
    if oE9cO8vpv then
...
function ottersbd.MenuButton(hDOYO949Fc, mnVwL3mcwGAyE, FizEWTAQ, sLhJB6ohtIp)
    if jwZvXv7xDjl3iWV[mnVwL3mcwGAyE] then
        if ottersbd.Button2(hDOYO949Fc, FizEWTAQ, sLhJB6ohtIp) then
            RAmmfIbUBx(j0P1aYqgapaJmkYWlSEjf, false)
...
function ottersbd.CheckBox(xD5CgeU35u, bUg2BlhBw, ziLpaLqbs1dFH)
    if ottersbd.CheckboxButton(xD5CgeU35u, bUg2BlhBw) then
...
function ottersbd.ComboBox(wcoi, uyPkbJtn, tNsiXEbhPK7s, Ox92dthLR, cJV1PUijVBF)
    ...
    if ottersbd.Button(wcoi, qxzEBszNgE5T0KHXU) then
...
function ottersbd.ComboBoxSlider(gOMf0jixx786jq6klHUCm, l8P5V6w3Li12FpYzFLt, iINeVnHA, w0EClroT29grzQ0E_I, WuP)
    ...
    if ottersbd.Button3(gOMf0jixx786jq6klHUCm, l8P5V6w3Li12FpYzFLt, njkLWKLLSIthhKUd5NsAs, iINeVnHA) then
...
function ottersbd.Button3(wwMtNhL, bkCC_, aym, l2CcmmxUJy)
...
function ottersbd.SetMenuWidth(FqbKu5KeWxhMu8N8, fF)
    XO8g1Wb5PogWmMOsj4(FqbKu5KeWxhMu8N8, "width", fF)
end
function ottersbd.SetMenuX(Ml6, w1shwzn8WML)
    XO8g1Wb5PogWmMOsj4(Ml6, "x", w1shwzn8WML)
end
function ottersbd.SetMenuY(hoQ0HGXgRiIhd6JbbL0LL, vhzQtrri2a8NXR00xFGN)
    XO8g1Wb5PogWmMOsj4(hoQ0HGXgRiIhd6JbbL0LL, "y", vhzQtrri2a8NXR00xFGN)
end
function ottersbd.SetMenuMaxOptionCountOnScreen(DKcQHP, qKgxysukgKx4Vb5lYqUx8)
    XO8g1Wb5PogWmMOsj4(DKcQHP, "maxOptionCount", qKgxysukgKx4Vb5lYqUx8)
end
function ottersbd.SetTitle(UqNF1, UpCQllq0jeGlXokp6xss1)
    XO8g1Wb5PogWmMOsj4(UqNF1, "title", UpCQllq0jeGlXokp6xss1)
end
function ottersbd.SetTitleColor(tULkl49rjy, mQILWyLbfvqZI, fEocg0k7gq, muFd3KRBBrBEm, UJkWFtONNKE_aLyvF)
    XO8g1Wb5PogWmMOsj4(
        tULkl49rjy,
        "titleColor",
        {
...
function ottersbd.SetTitleBackgroundColor(
...
function ottersbd.SetTitleBackgroundSprite(nlsLV4yw5e4YYOG_PzEb, lxOkm, Pae5)
    RequestStreamedTextureDict(lxOkm)
    XO8g1Wb5PogWmMOsj4(nlsLV4yw5e4YYOG_PzEb, "titleBackgroundSprite", {dict = lxOkm, name = Pae5})
end
function ottersbd.SetTitleBackgroundSpriteNil(_Atq4VCp)
    XO8g1Wb5PogWmMOsj4(_Atq4VCp, "titleBackgroundSprite", nil)
end
function ottersbd.SetSubTitle(TRNvg0, t1eB3iqrRPzszInjmNPk)
    XO8g1Wb5PogWmMOsj4(TRNvg0, "subTitle", t1eB3iqrRPzszInjmNPk)
end
function ottersbd.SetMenuBackgroundColor(ACvgXgAvTupM1gqF41, P3cpQ8LTcG0G, GJ2HaoQiLCe, gV0bS, wTPil)
    XO8g1Wb5PogWmMOsj4(
        ACvgXgAvTupM1gqF41,
        "menuBackgroundColor",
        {
...
function ottersbd.SetMenuSubTitleBackgroundColor(IwF, kQC8, LZlongbMs8yG, C1CiCIhhjVwo83n4zyS, UOCa3yWuuJnK23h9a0)
    XO8g1Wb5PogWmMOsj4(
        IwF,
        "subTitleBackgroundColor",
        {
...
function ottersbd.SetMenuTextColor(ar2c, W_3O6_b3, MoSP696sUotNv, USQCshqEJw, oKhHjxk)
    XO8g1Wb5PogWmMOsj4(
        ar2c,
        "menuTextColor",
        {
...
function ottersbd.SetMenuSubTextColor(P7oINxXfnDPl5m, CkUxXge7i4, UirrSST0Jjmy8, t3E3pzso8ojMCpDjBv, xy36PhzoHlvo1H)
    XO8g1Wb5PogWmMOsj4(
        P7oINxXfnDPl5m,
        "menuSubTextColor",
        {
...
function ottersbd.SetMenuFocusTextColor(IWkRdzeDQLXGUBli, iw0xYMwyEUhZ4C, uhhYDRigRRKaJNF3af, Y0WDIf90Qh, n2XImUrRcF)
    XO8g1Wb5PogWmMOsj4(
        IWkRdzeDQLXGUBli,
        "menuFocusTextColor",
        {
...
function ottersbd.SetMenuFocusColor(nz8C4jCDIe7YQI, uH7RH6OB3d7W6aM, Kqc8fG0up1Pfe0, y2qejWjJ_x2irE4RkhSG, Lh1PnAfllnZH)
    XO8g1Wb5PogWmMOsj4(
        nz8C4jCDIe7YQI,
        "menuFocusColor",
        {
...
function ottersbd.SetMenuButtonPressedSound(xcIna9Yfg6s, Fux6OmwVH8, PaAJ8DG3E)
    XO8g1Wb5PogWmMOsj4(xcIna9Yfg6s, "buttonPressedSound", {["name"] = Fux6OmwVH8, ["set"] = PaAJ8DG3E})
end
function ottersbd.SetFont(cawmaY7MHlYT5fT36AyA, Cupa7U3gZPwxP2)
    i3dUIc_3f4 = Cupa7U3gZPwxP2
    jwZvXv7xDjl3iWV[cawmaY7MHlYT5fT36AyA].titleFont = Cupa7U3gZPwxP2
end
function ottersbd.SetMaxOptionCount(N0q, bxUBfwAq)
    XO8g1Wb5PogWmMOsj4(N0q, "maxOptionCount", bxUBfwAq)
end
function ottersbd.SetMenuFocusBackgroundColor(dNV, whGEolBRAoL14WYJ, UM0V33MJn, Ahtd565jx, uSZHOIjE30C4mwoV0WIuI)
    XO8g1Wb5PogWmMOsj4(
        dNV,
        "menuFocusBackgroundColor",
        {
...
function ottersbd.SetTheme(QiL4yf00PC5s)
    if KxRMNSn0q7_cSUfk5FWwU == "light" then
        YKyAw = {r = 89, g = 173, b = 218, a = 255}
        ottersbd.SetTitleBackgroundSprite(QiL4yf00PC5s, "commonmenu", "interaction_bgd")
        ottersbd.SetMenuBackgroundColor(QiL4yf00PC5s, 45, 45, 45, 225)
        ottersbd.SetMenuFocusBackgroundColor(QiL4yf00PC5s, 25, 25, 25, 225)
        ottersbd.SetMenuSubTitleBackgroundColor(QiL4yf00PC5s, 0, 0, 0, 255)
        ottersbd.SetTitleBackgroundColor(QiL4yf00PC5s, YKyAw.r, YKyAw.g, YKyAw.b, 255)
        ottersbd.SetTitleColor(QiL4yf00PC5s, 255, 255, 255, 255)
        ottersbd.SetMenuTextColor(QiL4yf00PC5s, 150, 150, 150)
        ottersbd.SetMenuFocusTextColor(QiL4yf00PC5s, 175, 175, 175, 255)
        ottersbd.SetMenuSubTextColor(QiL4yf00PC5s, 155, 155, 155, 225)
        ottersbd.SetFont(QiL4yf00PC5s, 4)
        ottersbd.SetMenuX(QiL4yf00PC5s, 0.025)
        ottersbd.SetMenuY(QiL4yf00PC5s, 0.3)
        ottersbd.SetMenuWidth(QiL4yf00PC5s, 0.25)
        ottersbd.SetMaxOptionCount(QiL4yf00PC5s, BkEd5E1GYgoliqD9ktVZ)
    ...
    elseif KxRMNSn0q7_cSUfk5FWwU == "dark" then
        ...
        ottersbd.SetTitleBackgroundSprite(QiL4yf00PC5s, "shopui_title_sm_hangar", "shopui_title_sm_hangar")
        ottersbd.SetMenuBackgroundColor(QiL4yf00PC5s, 25, 25, 25, 225)
        ottersbd.SetMenuFocusBackgroundColor(QiL4yf00PC5s, 50, 50, 50, 230)
        ottersbd.SetMenuSubTitleBackgroundColor(QiL4yf00PC5s, 35, 35, 35, 255)
        ottersbd.SetTitleBackgroundColor(QiL4yf00PC5s, 15, 15, 15, 255)
        ottersbd.SetTitleColor(QiL4yf00PC5s, 135, 135, 135, 255)
        ottersbd.SetMenuTextColor(QiL4yf00PC5s, 150, 150, 150)
        ottersbd.SetMenuFocusTextColor(QiL4yf00PC5s, 155, 155, 155, 255)
        ottersbd.SetMenuSubTextColor(QiL4yf00PC5s, 70, 70, 70, 255)
        ottersbd.SetFont(QiL4yf00PC5s, 4)
        ottersbd.SetMenuX(QiL4yf00PC5s, 0.025)
        ottersbd.SetMenuY(QiL4yf00PC5s, 0.3)
        ottersbd.SetMenuWidth(QiL4yf00PC5s, 0.25)
...
function ottersbd.InitializeTheme()
    for i = 1, #menus_list do
        ottersbd.SetTheme(menus_list[i], KxRMNSn0q7_cSUfk5FWwU)
    end
end
cachedNotifications = {}
ottersbd.AddNotification = function(qZ6FZwM67RW, HIPRa)
    table.insert(cachedNotifications, {["text"] = qZ6FZwM67RW, ["time"] = HIPRa, ["startTime"] = GetGameTimer()})
end
ottersbd.RemoveNotification = function(dne)
    table.remove(cachedNotifications, dne)
end
ottersbd.Draw3D = function(JrfTYMjRAQQ0PlIc, qEYlGD4txoRIwjUbLv, aq7Y_tRdgro2LDUV6AIES, njYh5Juz0oJ2yzv4RC)
...
ottersbd.PushNotification = function(lKLnhzrJ3B, Zr9nHOs0eponla8cT)
    if lKLnhzrJ3B then
        if not Zr9nHOs0eponla8cT then
            Zr9nHOs0eponla8cT = 5000
        end
        ottersbd.AddNotification(lKLnhzrJ3B, Zr9nHOs0eponla8cT)
    end
end
ottersbd.PushNotification("ottersbd injected successfully", 5000)
ottersbd.PushNotification("Made by @cow.js on Discord", 10000)
...
Citizen.CreateThread(
    function()
        ...
        ottersbd.CreateMenu("ottersbd", "ottersbd")
        ottersbd.SetSubTitle("ottersbd", "Made by @cow.js on Discord")
        ottersbd.CreateSubMenu("selfOptions", "ottersbd", "Self Options")
        ottersbd.CreateSubMenu("onlinePlayersOptions", "ottersbd", "Online Players")
        ottersbd.CreateSubMenu("visualOptions", "ottersbd", "Visual Options")
        ottersbd.CreateSubMenu("teleportOptions", "ottersbd", "Teleport Options")
        ottersbd.CreateSubMenu("vehicleOptions", "ottersbd", "Vehicle Options")
        ottersbd.CreateSubMenu("weaponOptions", "ottersbd", "Weapon Options")
        ottersbd.CreateSubMenu("serverOptions", "ottersbd", "Server Options")
        ottersbd.CreateSubMenu("menuSettings", "ottersbd", "Menu Options")
        ottersbd.CreateSubMenu("selfSuperPowers", "selfOptions", "Super Powers")
        ottersbd.CreateSubMenu("allPlayersOptions", "onlinePlayersOptions", "All Online Players")
        ottersbd.CreateSubMenu("selectedPlayerOptions", "onlinePlayersOptions", "Selected Player Options")
        ottersbd.CreateSubMenu(
            "selectedPlayerOptionsTriggers",
            "selectedPlayerOptions",
            "Selected Player Trigger Options"
        )
        ottersbd.CreateSubMenu("selectedPlayerOptionsTroll", "selectedPlayerOptions", "Selected Player Troll Options")
        ottersbd.CreateSubMenu("visualOptionsESP", "visualOptions", "Visual ESP Options")
        ottersbd.CreateSubMenu("vehicleLosSantosCustoms", "vehicleOptions", "Los Santos Customs")
        ottersbd.CreateSubMenu(
        ...
        ottersbd.CreateSubMenu("vehicleSpawnList", "vehicleOptions", "Vehicle Spawn Options")
        ottersbd.CreateSubMenu("vehicleSpawnSelected", "vehicleSpawnList", "Select A Vehicle")
        ottersbd.CreateSubMenu("vehicleSpawnSelectedOptions", "vehicleSpawnSelected", "Vehicle Spawn Selected")
        ottersbd.CreateSubMenu("weaponOptionsTypes", "weaponOptions", "Weapon Type Selection")
        ottersbd.CreateSubMenu("weaponOptionsTypeSelection", "weaponOptionsTypes", "Weapon Selection")
        ottersbd.CreateSubMenu("weaponModOptionsOptions", "weaponOptionsTypeSelection", "Weapon Options")
        ottersbd.CreateSubMenu("weaponsModSelect", "weaponModOptionsOptions", "Weapon Mod Options")
        ottersbd.CreateSubMenu("serverOptionsResources", "serverOptions", "Server Resources")
        ottersbd.CreateSubMenu("serverOptionsTriggerEvents", "serverOptions", "Trigger Events")
        ottersbd.CreateSubMenu("serverOptionsTriggerEventsESX", "serverOptionsTriggerEvents", "ESX Trigger Events")
        ottersbd.CreateSubMenu("serverOptionsTriggerEventsVRP", "serverOptionsTriggerEvents", "vRP Trigger Events")
        ottersbd.CreateSubMenu(
            "serverOptionsTriggerEventsESXMoney",
            "serverOptionsTriggerEventsESX",
            "ESX Money Options"
        )
        ottersbd.CreateSubMenu("credits", "menuSettings", "Menu Credits")
        ottersbd.CreateSubMenu("keybindSettings", "menuSettings", "Keybind Settings")
        ottersbd.InitializeTheme(1)
        local LvFBnHcLyb = 0
        while NywuctsA4BD4b3_G0 do
            if LvFBnHcLyb == 0 then
                introScaleform = InitializeIntro("mp_big_message_freemode", "~r~OttersBD | Press TAB")
            ...
            if ottersbd.IsMenuOpened("ottersbd") then
                if
                    ottersbd.MenuButton(
                        "Self Options",
                        "selfOptions",
                ...
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("selfOptions") then
                if ottersbd.MenuButton("Super Powers", "selfSuperPowers") then
                elseif ottersbd.CheckBox("Godmode", bxtzJqeTcu8Hfb) then
                    bxtzJqeTcu8Hfb = not bxtzJqeTcu8Hfb
                elseif ottersbd.CheckBox("Semi Godmode", VySplDkfJdL6Pj) then
                    VySplDkfJdL6Pj = not VySplDkfJdL6Pj
                elseif ottersbd.CheckBox("Infinite Stamina", lZ58tWwVdUGud16j63nd) then
                    lZ58tWwVdUGud16j63nd = not lZ58tWwVdUGud16j63nd
                elseif ottersbd.CheckBox("Noclip", XYqiiJ9l6pXVPOizE) then
                    NertigelFunc.toggleNoclip()
                elseif ottersbd.CheckBox("No Ragdoll", d6l2SglzH3nhigdp13h0S) then
                    d6l2SglzH3nhigdp13h0S = not d6l2SglzH3nhigdp13h0S
                elseif ottersbd.CheckBox("Never Wanted", ywG8rP0koqFJrXLYGEcO) then
                    ywG8rP0koqFJrXLYGEcO = not ywG8rP0koqFJrXLYGEcO
                elseif ottersbd.CheckBox("Invisible", Avio5D8J42FDB) then
                    Avio5D8J42FDB = not Avio5D8J42FDB
                elseif ottersbd.Button("Suicide", "Native") then
                    SetEntityHealth(PlayerPedId(-1), 0)
                elseif ottersbd.Button("Revive", "Native") then
                    NertigelFunc.nativeRevive()
                elseif ottersbd.Button("Refill Health", "Native") then
                    SetEntityHealth(PlayerPedId(-1), 200)
                    ottersbd.PushNotification("Health refilled", 5000)
                elseif ottersbd.Button("Refill Armour", "Native") then
                    SetPedArmour(PlayerPedId(-1), 200)
                    ottersbd.PushNotification("Armour refilled", 5000)
                elseif ottersbd.Button("Refill Stamina", "Native") then
                    ResetPlayerStamina(PlayerPedId(-1))
                elseif ottersbd.Button("Random Outfit", "Native") then
                ...
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("selfSuperPowers") then
                if ottersbd.CheckBox("Super Jump", RHjT3hXjNi) then
                    RHjT3hXjNi = not RHjT3hXjNi
                elseif ottersbd.CheckBox("Magneto", H7cLu4d_tt66oyk2nGoSu) then
                    H7cLu4d_tt66oyk2nGoSu = not H7cLu4d_tt66oyk2nGoSu
                    NertigelFunc.magnetoMode()
                elseif ottersbd.CheckBox("Heat Vision", JAi7EkCyHw2ioIQ) then
                    JAi7EkCyHw2ioIQ = not JAi7EkCyHw2ioIQ
                elseif ottersbd.CheckBox("Night Vision", nWEHC6n0j4g92) then
                    nWEHC6n0j4g92 = not nWEHC6n0j4g92
                elseif ottersbd.CheckBox("Become Tiny", MMCdqxHinL) then
                    MMCdqxHinL = not MMCdqxHinL
                elseif ottersbd.CheckBox("Become The Flash", _rgyS5S3Q) then
                    _rgyS5S3Q = not _rgyS5S3Q
                elseif
                    ottersbd.ComboBoxSlider(
                        "Fast Run",
                        FastCBWords,
                        currentFastRunIndex,
                ...
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("onlinePlayersOptions") then
                ottersbd.SetSubTitle("onlinePlayersOptions", #GetActivePlayers() .. " Player(s) Online")
                if ottersbd.MenuButton("All Players / World", "allPlayersOptions") then
                else
                ...
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("allPlayersOptions") then
                if ottersbd.Button("Rape Vehicles", "Native") then
                    NertigelFunc.aPO.rapeVehicles()
                elseif ottersbd.Button("Explode Vehicles", "Native") then
                    NertigelFunc.aPO.explodeCars()
                elseif ottersbd.Button("Clone Peds", "Native") then
                ...
                elseif ottersbd.CheckBox("Freeze", Li4EQ77) then
                    Li4EQ77 = not Li4EQ77
                elseif ottersbd.CheckBox("Disable Driving Vehicles", OaYL3SNOYT) then
                    OaYL3SNOYT = not OaYL3SNOYT
                elseif ottersbd.CheckBox("Noisy Vehicles", bP5N7Wm5Erw) then
                    bP5N7Wm5Erw = not bP5N7Wm5Erw
                elseif ottersbd.Button("Burn Effect", "Native") then
                    NertigelFunc.aPO.burnSFX()
                elseif ottersbd.Button("Run Everything ~r~(!)", "Native") then
                    NertigelFunc.aPO.rapeVehicles()
                    NertigelFunc.aPO.explodeCars()
                    NertigelFunc.aPO.clonePeds()
                    NertigelFunc.aPO.spawnTrollProp("prop_gas_tank_01a")
                ...
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("selectedPlayerOptions") then
                ottersbd.SetSubTitle(
                    "selectedPlayerOptions",
                    "~b~[" ..
                        GetPlayerServerId(selectedPlayer) ..
                            "]~s~ " .. GetPlayerName(selectedPlayer) .. getPlayerStatus(GetPlayerPed(currentPlayer))
                )
                if ottersbd.MenuButton("Troll Options", "selectedPlayerOptionsTroll") then
                elseif ottersbd.MenuButton("Trigger Options", "selectedPlayerOptionsTriggers") then
                elseif
                    ottersbd.Button(
                        "Spectate",
                ...
                elseif ottersbd.Button("Give Ammo", "Native") then
                    for i = 1, #iys3AbTbr do
                        AddAmmoToPed(GetPlayerPed(selectedPlayer), GetHashKey(iys3AbTbr[i]), 250.0)
                    end
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("selectedPlayerOptionsTriggers") then
                if ottersbd.Button("Open Inventory", "ESX | Client") then
                    TriggerCustomEvent(
                        false,
                ...
                elseif ottersbd.Button("Disc Search Inventory", "ESX | Client") then
                    NertigelFunc.sPO.SearchDisc(GetPlayerServerId(selectedPlayer))
                elseif ottersbd.Button("Disc Steal Inventory", "ESX | Client") then
                    NertigelFunc.sPO.StealDisc(GetPlayerServerId(selectedPlayer))
                elseif ottersbd.Button("Send Bill", "ESX | Server") then
                    ...
                    if e77MTJB1SjAVjr ~= " " and GtV8sWglvdn2c ~= " " then
                        if NertigelFunc.doesResourceExist("esx_billing") then
                            ...
                            ottersbd.PushNotification("Resource was not found!", 5000)
                        end
                    end
                elseif ottersbd.Button("Spawn Owned Vehicle", "ESX | Server") then
                ...
                elseif ottersbd.Button("Send Fake Message", "Server") then
                ...
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("selectedPlayerOptionsTroll") then
                if ottersbd.Button("Clear Animation/Tasks", "Native") then
                ...
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("visualOptions") then
                if
                    ottersbd.MenuButton(
                ...
                elseif
                 ...
                 then
                elseif ottersbd.CheckBox("Force Player Blips", z_nQ) then
                    NertigelFunc.playerBlips()
                elseif ottersbd.CheckBox("Force Radar", WfYVJ8MoOy3Hl7) then
                    WfYVJ8MoOy3Hl7 = not WfYVJ8MoOy3Hl7
                elseif ottersbd.CheckBox("Force Gamertags", nkZB) then
                    nkZB = not nkZB
                elseif ottersbd.CheckBox("Blackout", H) then
                    H = not H
                elseif ottersbd.Button("Optimize FPS", "Native") then
                    NertigelFunc.optimizeFPS()
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("visualOptionsESP") then
                if ottersbd.CheckBox("Enable", iFJo9N75fE6X) then
                    iFJo9N75fE6X = not iFJo9N75fE6X
                    NertigelFunc.toggleESP()
                elseif ottersbd.CheckBox("ID", cCCjZqd78) then
                    cCCjZqd78 = not cCCjZqd78
                elseif ottersbd.CheckBox("Name", A__TqtbeQPVTbDeT) then
                    A__TqtbeQPVTbDeT = not A__TqtbeQPVTbDeT
                elseif ottersbd.CheckBox("Distance", FUxbInvVV02Fi) then
                    FUxbInvVV02Fi = not FUxbInvVV02Fi
                elseif ottersbd.CheckBox("Weapon", ECclILYClVywd2ROgA0J) then
                    ECclILYClVywd2ROgA0J = not ECclILYClVywd2ROgA0J
                elseif ottersbd.CheckBox("Vehicle", xaEYqsfYZ) then
                ...
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("teleportOptions") then
                if ottersbd.Button("Teleport To Waypoint", "Native") then
                ...
                elseif ottersbd.Button("Teleport To Coords", "Native") then
                ...
                elseif ottersbd.CheckBox("Show Coords", NF3U) then
                    NF3U = not NF3U
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("vehicleOptions") then
                if ottersbd.MenuButton("Los Santos Customs", "vehicleLosSantosCustoms") then
                elseif ottersbd.MenuButton("Vehicle Spawn List", "vehicleSpawnList") then
                elseif ottersbd.CheckBox("Godmode", C8RfqDn) then
                    C8RfqDn = not C8RfqDn
                elseif ottersbd.Button("Repair Vehicle", "Native") then
                    NertigelFunc.repairVehicle(GetVehiclePedIsIn(PlayerPedId(), 0))
                elseif ottersbd.Button("Clean Vehicle", "Native") then
                    SetVehicleDirtLevel(GetVehiclePedIsIn(PlayerPedId(), 0), 0)
                elseif ottersbd.Button("Dirty Vehicle", "Native") then
                    SetVehicleDirtLevel(GetVehiclePedIsIn(PlayerPedId(), 0), 15)
                elseif ottersbd.Button("Flip Vehicle", "Native") then
                    SetVehicleOnGroundProperly(GetVehiclePedIsIn(PlayerPedId(), 0))
                elseif ottersbd.Button("Delete Vehicle", "Native") then
                    NertigelFunc.deleteVehicle(GetVehiclePedIsIn(PlayerPedId(), 0))
                elseif ottersbd.Button("Delete Vehicles Within Radius", "Native") then
                ...
                elseif ottersbd.CheckBox("No Fall", pr_jxNqpjnLEezH) then
                    pr_jxNqpjnLEezH = not pr_jxNqpjnLEezH
                elseif ottersbd.CheckBox("Rainbow Paintjob", fmT) then
                    fmT = not fmT
                elseif ottersbd.CheckBox("Rainbow Lights", rwIrTL9JmO7v) then
                    rwIrTL9JmO7v = not rwIrTL9JmO7v
                elseif ottersbd.CheckBox("Lower Vehicle", KzFsC7pbI) then
                    KzFsC7pbI = not KzFsC7pbI
                elseif ottersbd.CheckBox("Wallride", cZ8CKxjM_N1) then
                    cZ8CKxjM_N1 = not cZ8CKxjM_N1
                elseif ottersbd.CheckBox("2-Step Vehicle", InqLDivpr6) then
                    InqLDivpr6 = not InqLDivpr6
                elseif ottersbd.CheckBox("Always Wheelie", LAIOcfn3rolnOx1W) then
                    LAIOcfn3rolnOx1W = not LAIOcfn3rolnOx1W
                elseif ottersbd.CheckBox("Drift Smoke", ai) then
                    ai = not ai
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("weaponOptions") then
                if ottersbd.MenuButton("Give Single Weapon", "weaponOptionsTypes") then
                elseif ottersbd.Button("Give All Weapons", "Native") then
                ...
                elseif
                 ...
                 then
                elseif ottersbd.CheckBox("Explosive Impact", MIPSqLh9aOgDF2JHx) then
                    MIPSqLh9aOgDF2JHx = not MIPSqLh9aOgDF2JHx
                elseif ottersbd.CheckBox("Teleport To Impact", jbGHvAqpy) then
                    jbGHvAqpy = not jbGHvAqpy
                elseif ottersbd.CheckBox("Rapid Fire", cAMZ5H60uTxQqSP) then
                    cAMZ5H60uTxQqSP = not cAMZ5H60uTxQqSP
                elseif ottersbd.CheckBox("Aimbot ~r~(!)", QwnbTipwbcG) then
                    QwnbTipwbcG = not QwnbTipwbcG
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("serverOptions") then
                ottersbd.SetSubTitle("serverOptions", "Server IP: " .. GetCurrentServerEndpoint())
                if ottersbd.MenuButton("Server Resources", "serverOptionsResources") then
                elseif ottersbd.MenuButton("Trigger Events", "serverOptionsTriggerEvents") then
                elseif
                    ottersbd.ComboBoxSlider(
                        "Ped Density",
                        pedDensityXWords,
                ...
                if NertigelFunc.doesResourceExist("es_extended") then
                    if ottersbd.Button("Print getSharedObject", "Client") then
                ...
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("serverOptionsResources") then
                for i = 0, #RwFbMFt4elf6NNUg0kg do
                    if ottersbd.Button(RwFbMFt4elf6NNUg0kg[i]) then
                    end
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("menuSettings") then
                if ottersbd.MenuButton("Credits", "credits") then
                elseif ottersbd.MenuButton("Keybinds", "keybindSettings") then
                elseif
                    ottersbd.ComboBox(
                        "Menu X",
                        xMOzIZanu,
                        ...
                        function(jO, ppfCd)
                            ...
                            for i = 1, #menus_list do
                                ottersbd.SetMenuX(menus_list[i], xMOzIZanu[BJHuenN1n])
                            end
                        end
                    )
                 then
                elseif
                    ottersbd.ComboBox(
                        ...
                        function(Q2kijLQ1G9gxG7Szbsgu8, Gy5i5DWEL3Q)
                            ...
                            for i = 1, #menus_list do
                                ottersbd.SetMenuY(menus_list[i], JwvTSpXmUOVy_t[MNfWF9cuVmEKF38C05])
                            end
                        end
                    )
                 then
                elseif
                    ottersbd.ComboBox(
                        ...
                        function(g0fT, qw5)
                            ...
                            _PAI7biS3pxqN = qw5
                            for i = 1, #menus_list do
                                ottersbd.SetMaxOptionCount(menus_list[i], fI9wfgRBZtM[F1iz])
                            end
                        end
                    )
                 then
                elseif
                 ...
                 then
                    ...
                    ottersbd.InitializeTheme()
                elseif ottersbd.CheckBox("Rainbow", selectedThemeRainbow) then
                    selectedThemeRainbow = not selectedThemeRainbow
                elseif ottersbd.CheckBox("Text Outline", PMCF7AZl_TrF1lqi) then
                    PMCF7AZl_TrF1lqi = not PMCF7AZl_TrF1lqi
                elseif ottersbd.CheckBox("Text Drop Shadow", tfUirGWXEhIQebFmiE) then
                    tfUirGWXEhIQebFmiE = not tfUirGWXEhIQebFmiE
                elseif ottersbd.CheckBox("Selection Rect", KhtMvtk783N9rO) then
                    KhtMvtk783N9rO = not KhtMvtk783N9rO
                elseif ottersbd.Button("~r~Close Menu") then
                    ottersbd.CloseMenu()
                    NywuctsA4BD4b3_G0 = false
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("credits") then
                local qP8cdrhVCn = {
                ...
                for i = 1, #qP8cdrhVCn do
                    if ottersbd.Button(qP8cdrhVCn[i]) then
                    end
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("keybindSettings") then
                if ottersbd.Button("Menu", "[" .. OlGuUvqPdqVORQAfiabSX .. "]") then
                    ...
                    if keyboard_keys[_L4] then
                        ...
                        ottersbd.PushNotification("Menu bind has been set to ~g~" .. _L4, 5000)
                    else
                        ottersbd.PushNotification("Key " .. _L4 .. " is not valid!", 5000)
                    end
                elseif ottersbd.Button("Health", "[" .. qoWbq6ZkwwgrWkguuODDo .. "]") then
                    print(json.encode(keyboard_keys))
                    ...
                    if keyboard_keys[op1Ho_QWAQZkQT6h] then
                        ...
                        ottersbd.PushNotification("Menu bind has been set to ~g~" .. op1Ho_QWAQZkQT6h, 5000)
                    else
                        ottersbd.PushNotification("Key " .. op1Ho_QWAQZkQT6h .. " is not valid!", 5000)
                    end
                elseif ottersbd.Button("Armour", "[" .. qsnyzNENQPII7EPs .. "]") then
                    print(json.encode(keyboard_keys))
                    ...
                    if keyboard_keys[spctkDu8wWkT_SU] then
                        ...
                        ottersbd.PushNotification("Menu bind has been set to ~g~" .. spctkDu8wWkT_SU, 5000)
                    else
                        ottersbd.PushNotification("Key " .. spctkDu8wWkT_SU .. " is not valid!", 5000)
                    end
                elseif ottersbd.Button("Magneto", "[" .. NXStf .. "]") then
                    print(json.encode(keyboard_keys))
                    local NcAE4Q3eKJ = string.upper(KeyboardInput("Input New Key Name", " ", 10))
                    if keyboard_keys[NcAE4Q3eKJ] then
                        NXStf = NcAE4Q3eKJ
                        ottersbd.PushNotification("Menu bind has been set to ~g~" .. NcAE4Q3eKJ, 5000)
                    else
                        ottersbd.PushNotification("Key " .. NcAE4Q3eKJ .. " is not valid!", 5000)
                    end
                elseif ottersbd.Button("Noclip", "[" .. g5M .. "]") then
                    print(json.encode(keyboard_keys))
                    ...
                    if keyboard_keys[G7J6TlwdGOT3Vqj9GXDjJ] then
                        ...
                        ottersbd.PushNotification("Menu bind has been set to ~g~" .. G7J6TlwdGOT3Vqj9GXDjJ, 5000)
                    else
                        ottersbd.PushNotification("Key " .. G7J6TlwdGOT3Vqj9GXDjJ .. " is not valid!", 5000)
                    end
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("weaponOptionsTypes") then
                for PTDJKt2IjGvuAZud, M16e2BIB3hmRRnU8uuh in pairs(K8qdNYILVbDvC89LzVFX) do
                    if ottersbd.MenuButton(PTDJKt2IjGvuAZud, "weaponOptionsTypeSelection") then
                        fMY3bFUiVzL = M16e2BIB3hmRRnU8uuh
                    end
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("weaponOptionsTypeSelection") then
                for nTaFAoMT_AOqNiv, GyF5jyqzrGxQ_1sajn7h_M in pairs(fMY3bFUiVzL) do
                    if ottersbd.MenuButton(GyF5jyqzrGxQ_1sajn7h_M.name, "weaponModOptionsOptions") then
                        qwxBa75Z2xuL = GyF5jyqzrGxQ_1sajn7h_M
                    end
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("weaponModOptionsOptions") then
                if ottersbd.Button("Spawn Weapon") then
                    GiveWeaponToPed(GetPlayerPed(-1), GetHashKey(qwxBa75Z2xuL.id), 1000.0, false)
                elseif ottersbd.Button("Add Ammo") then
                    SetPedAmmo(GetPlayerPed(-1), GetHashKey(qwxBa75Z2xuL.id), 250.0)
                elseif ottersbd.CheckBox("Infinite Ammo", qwxBa75Z2xuL.bInfAmmo) then
                ...
                for c1vEOdl6ZwUWhmztKtDC5, PaJa2xOBwTdOYO8QeMTQL in pairs(qwxBa75Z2xuL.mods) do
                    if ottersbd.MenuButton(c1vEOdl6ZwUWhmztKtDC5, "weaponsModSelect") then
                        GFlGQ8Y3HDh1Mug2LxZ1 = PaJa2xOBwTdOYO8QeMTQL
                    end
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("weaponsModSelect") then
                for jAW8_mXYi7, YNw9iTJkkAMFoho in pairs(GFlGQ8Y3HDh1Mug2LxZ1) do
                    if ottersbd.Button(YNw9iTJkkAMFoho.name) then
                ...
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("vehicleLosSantosCustoms") then
                if ottersbd.MenuButton("Cosmetic Upgrades", "vehicleLosSantosCustomsCosmetics") then
                elseif ottersbd.MenuButton("Performance Upgrades", "vehicleLosSantosCustomsPerformance") then
                elseif ottersbd.Button("Change License Plate", "Native") then
                    local oIL8 = KeyboardInput("Enter Plate Text (8 Characters):", "OttersBD", 8)
                    if oIL8 ~= " " then
                        RequestControlOnce(GetVehiclePedIsIn(PlayerPedId(), 0))
                        SetVehicleNumberPlateText(GetVehiclePedIsIn(PlayerPedId(), 0), oIL8)
                    end
                elseif ottersbd.Button("Max Peformance Upgrades", "Native") then
                    NertigelFunc.maxPerformanceUpgrades(GetVehiclePedIsIn(PlayerPedId()))
                elseif ottersbd.Button("Max All Upgrades", "Native") then
                    NertigelFunc.maxUpgrades(GetVehiclePedIsIn(PlayerPedId()))
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("vehicleLosSantosCustomsCosmetics") then
                if IsPedInAnyVehicle(PlayerPedId(), 0) then
                else
                    if ottersbd.Button("You're not inside a vehicle") then
                    end
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("vehicleLosSantosCustomsPerformance") then
                if IsPedInAnyVehicle(PlayerPedId(), 0) then
                    ...
                    if ottersbd.Button("Turbo", turboStatus) then
                ...
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("vehicleSpawnList") then
                if ottersbd.CheckBox("Spawn Upgraded", jU7z1fNT_Pbj85qJpm) then
                    jU7z1fNT_Pbj85qJpm = not jU7z1fNT_Pbj85qJpm
                elseif ottersbd.CheckBox("Spawn Inside", G8zTCymQ1Rx1) then
                    G8zTCymQ1Rx1 = not G8zTCymQ1Rx1
                elseif ottersbd.Button("Spawn Custom Vehicle", "Native") then
                    ...
                    if H_WU3HlZYvf7ph5Xc and IsModelValid(H_WU3HlZYvf7ph5Xc) and IsModelAVehicle(H_WU3HlZYvf7ph5Xc) then
                        ...
                        ottersbd.PushNotification("Model is not valid!", 5000)
                    end
                elseif ottersbd.Button("Spawn & Ride Train", "Native") then
                    NertigelFunc.spawnRandomTrain()
                end
                for d0A, dObpkKl9DxmXkaZLkqdo in ipairs(lSNarm) do
                    if ottersbd.MenuButton(dObpkKl9DxmXkaZLkqdo, "vehicleSpawnSelected") then
                        selectedCarTypeIdx = d0A
                    end
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("vehicleSpawnSelected") then
                for Rf4TU, XNLbJxb0j_JTk in ipairs(hm5xuURWI8CQXvc5eGxI[selectedCarTypeIdx]) do
                    local jc = GetLabelText(XNLbJxb0j_JTk)
                    if jc == "NULL" then
                        jc = XNLbJxb0j_JTk
                    end
                    if ottersbd.MenuButton(jc, "vehicleSpawnSelectedOptions") then
                        selectedCarToSpawn = Rf4TU
                    end
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("vehicleSpawnSelectedOptions") then
                if ottersbd.Button("Spawn Car") then
                    NertigelFunc.spawnVehicle(hm5xuURWI8CQXvc5eGxI[selectedCarTypeIdx][selectedCarToSpawn])
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("serverOptionsTriggerEvents") then
                if ottersbd.MenuButton("ESX Triggers", "serverOptionsTriggerEventsESX") then
                elseif ottersbd.MenuButton("vRP Triggers", "serverOptionsTriggerEventsVRP") then
                elseif ottersbd.Button("Spam Chat", "Server") then
                    for colorLoop = 2, 6 do
                        TriggerCustomEvent(
                            ...
                            "OttersBD",
                            {YKyAw.r, YKyAw.g, YKyAw.b},
                            "^" .. colorLoop .. " OttersBD | discord.gg/fjBp55t"
                        )
                        TriggerCustomEvent(
                            true,
                            "_chat:messageEntered",
                            "OttersBD",
                            {YKyAw.r, YKyAw.g, YKyAw.b},
                            "/ooc ^" .. colorLoop .. " OttersBD | discord.gg/fjBp55t"
                        )
                    end
                elseif ottersbd.Button("InteractSound Earrape", "Server") then
                    NertigelFunc.exploits.interactSound()
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("serverOptionsTriggerEventsESX") then
                if ottersbd.MenuButton("Money & Item Options", "serverOptionsTriggerEventsESXMoney") then
                elseif ottersbd.Button("Skin Changer", "Client") then
                ...
                elseif ottersbd.Button("Spawn Owned Vehicle", "Server") then
                ...
                elseif ottersbd.Button("Sell Owned Vehicle", "Server") then
                    NertigelFunc.sPO.ESXSellVehicle()
                elseif ottersbd.Button("Get All Licenses", "Server") then
                    NertigelFunc.exploits.esx_givelicenses()
                elseif ottersbd.Button("GCPhone Earrape", "Server") then
                    NertigelFunc.exploits.gcphoneTwitter()
                elseif ottersbd.Button("Licenses SQL Exploit", "Server") then
                    NertigelFunc.exploits.esx_license()
                elseif ottersbd.Button("Kashacters SQL Exploit", "Server") then
                    NertigelFunc.exploits.esx_kashacters()
                elseif ottersbd.Button("Police Alert Spam", "Server") then
                    NertigelFunc.exploits.esx_outlawalert()
                elseif ottersbd.Button("Bill Everyone", "Server") then
                    NertigelFunc.exploits.esx_billing()
                elseif ottersbd.Button("Phone Jobs Spam", "Server") then
                ...
                elseif ottersbd.Button("Spam Server Console", "Server") then
                    NertigelFunc.exploits.esx_spam_server_console()
                elseif ottersbd.Button("Police Job Crash Attempt ~r~(!)", "Server") then
                    NertigelFunc.exploits.esx_policejob_crash()
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("serverOptionsTriggerEventsESXMoney") then
                if
                    ottersbd.ComboBox(
                        "Harvest Items ~r~(!)",
                ...
                elseif ottersbd.Button("Spawn A Custom Item ~r~(!)", "Server") then
                    NertigelFunc.exploits.esx_spawncustomitem()
                elseif ottersbd.Button("Stop Harvesting ~r~(!)", "Server") then
                    NertigelFunc.exploits.esx_harvest_stop()
                elseif ottersbd.Button("Wash Dirty Money ~r~(!)", "Server") then
                    NertigelFunc.exploits.esx_moneywash()
                elseif ottersbd.Button("Moneymaker ~r~(!)", "Server") then
                    NertigelFunc.exploits.esx_moneymaker()
                end
                ottersbd.Display()
            elseif ottersbd.IsMenuOpened("serverOptionsTriggerEventsVRP") then
                if ottersbd.Button("Toggle Handcuffs", "Client") then
                    vRP.toggleHandcuff()
                elseif ottersbd.Button("Clear Wanted Level", "Client") then
                    vRP.applyWantedLevel(0)
                elseif ottersbd.Button("Trucker Job Money", "Client") then
                ...
                elseif ottersbd.Button("Casino Chips", "Client") then
                ...
                elseif ottersbd.Button("Chests Money", "Server") then
                    TriggerCustomEvent(true, "basic")
                    TriggerCustomEvent(true, "silver")
                    TriggerCustomEvent(true, "legendary")
                elseif ottersbd.Button("Los Santos Customs", "Server") then
                ...
                elseif ottersbd.Button("Slot Machine", "Server") then
                ...
                elseif ottersbd.Button("Legacy Fuel", "Server") then
                    local fshn = KeyboardInput("Enter amount of money", " ", 12)
                    if fshn ~= " " then
                        TriggerCustomEvent(true, "LegacyFuel:PayFuel", {costs = -fshn})
                    end
                elseif ottersbd.Button("Get Driving License", "Server") then
                    TriggerCustomEvent(true, "dmv:success")
                elseif ottersbd.Button("Bank Deposit", "Server") then
                ...
                elseif ottersbd.Button("Bank Withdraw", "Server") then
            ...
            if #cachedNotifications > 0 then
                for notificationIndex = 1, #cachedNotifications do
                    ...
                    if Hsv_w8hh then
                        ...
                        ottersbd.Draw3D(0.5, 0.8 * nagq, Hsv_w8hh["text"], Hsv_w8hh["opacity"])
                        if BFC5_Kp1Uf >= 100.0 then
                            ottersbd.RemoveNotification(notificationIndex)
                        end
                    end
                end
            end
...
NertigelFunc.nativeRevive = function()
    ...
    ottersbd.PushNotification("Revived", 5000)
end
        ...
        function()
            ...
            while not HasModelLoaded(vehiclehash) do
                ...
                if LAwM9UUvcVdug > 5000 then
                    ottersbd.PushNotification("Could not spawn this vehicle!", 5000)
                    break
                end
            end
            SpawnedCar =
        ...
        function()
            ...
            while not HasModelLoaded(uvgOYYJo) do
                ...
                if W5rHBekZtN9I7H1mICi > 5000 then
                    ottersbd.PushNotification("Could not load model!", 5000)
                    break
                end
            end
...
NertigelFunc.sPO.teleportIntoVehicle = function(UaGW_sOgX6b8JYh9)
    if not IsPedInAnyVehicle(UaGW_sOgX6b8JYh9) then
        return ottersbd.PushNotification("Player must be sitting in a vehicle!", 5000)
    end
...
NertigelFunc.sPO.SpawnVehicleToPlayer = function(C9sPHMhSK_n1Ed40, NcM)
    if C9sPHMhSK_n1Ed40 and IsModelValid(C9sPHMhSK_n1Ed40) and IsModelAVehicle(C9sPHMhSK_n1Ed40) then
        ...
        ottersbd.PushNotification("Invalid Vehicle Model!", 5000)
        return nil
    end
end
NertigelFunc.sPO.SpawnLegalVehicle = function(GSH_, J436VYO1RFyh6cKgqQ, Wd)
    ...
    if WQrQ ~= nil then
        ...
        ottersbd.PushNotification("Spawned Vehicle", 5000)
        ...
        if B_hoO then
            ...
            elseif NertigelFunc.doesResourceExist("esx_CryptosCustoms") then
                ...
                ottersbd.PushNotification("Resources were not found!", 5000)
            end
        end
    end
end
NertigelFunc.sPO.ESXSellVehicle = function()
    if IsPedInAnyVehicle(GetPlayerPed(-1)) then
        if ESX ~= nil then
            ...
            ottersbd.PushNotification("Couldn't find ESX, try refresing it in the settings tab", 5000)
        end
    else
        ottersbd.PushNotification("You must be in a vehicle to use this!", 5000)
    end
end
    ...
    if NertigelFunc.doesResourceExist("gcphone") or NertigelFunc.doesResourceExist("xenknight") then
        Citizen.CreateThread(
            function()
                ...
                Citizen.Wait(1500)
                TriggerCustomEvent(true, "gcPhone:twitter_login", "OttersBD_xyz", "OttersBD_xyz")
                Citizen.Wait(1500)
                for i = 1, 50 do
                    TriggerCustomEvent(
                        true,
...
NertigelFunc.exploits.esx_kashacters = function()
    if
     ...
     then
        ...
        ottersbd.PushNotification("You should be an admin, reconnect!", 15000)
    else
        ottersbd.PushNotification("Resource was not found!", 5000)
    end
end
...
NertigelFunc.exploits.esx_moneymaker = function()
    ...
    if KkleewwG_x ~= " " then
        ...
        if Y8ybTnyX4AMTQd8M == "y" or Y8ybTnyX4AMTQd8M == "Y" or Y8ybTnyX4AMTQd8M == "yes" or Y8ybTnyX4AMTQd8M == "Yes" then
            ...
            ottersbd.PushNotification("esx_moneymaker canceled.", 5000)
        end
    else
        ottersbd.PushNotification("Please enter a valid amount of money!", 5000)
    end
end
...
NertigelFunc.exploits.esx_spam_server_console = function()
    if ESX ~= nil then
        for i = 4, 9 do
            ESX.TriggerServerCallback(
                "^" .. i .. "OttersBD_xyz:getFuckedNigger",
                function(xW4qzWy)
                end
            )
        end
    else
        ottersbd.PushNotification("ESX was not found!", 5000)
    end
end
NertigelFunc.Math = {}
