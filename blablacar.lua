...
Citizen.CreateThread(function()
	...
	WarMenu.CreateMenu('MainMenu', '~w~OttersBD ~h~~r~3.0')
	WarMenu.SetSubTitle('MainMenu', 'Welcome to OttersBD '..player..'.')
	...
	while Enabled do
		...
		elseif intro == 100 then
			...
			if notif == 0 then
				...
				drawNotification("You are using OttersBD Menu~n~Private ! ~p~Enjoy :3")
				notif = 1
			end
			...
			elseif WarMenu.Button('~r~Unload OttersBD Menu') then
				Enabled = false
			elseif WarMenu.Button("Made by OttersBDliss#3694 :3 ") then
			end
